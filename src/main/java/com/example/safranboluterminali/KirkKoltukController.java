...
public class KirkKoltukController {
    private YetkiliController yetkiliController;

    @FXML
    private AnchorPane kirkKoltukPane;
    @FXML
    ...
    void initialize() {
        for (int i = 1; i <= 46; i++) {
            ...
            Button button = (Button) kirkKoltukPane.lookup("#" + buttonId);
            if (button != null) {
            ...
            try (PreparedStatement preparedStatement = connection.prepareStatement(sql)) {
                ...
                try (ResultSet resultSet = preparedStatement.executeQuery()) {
                    while (resultSet.next()) {
                        ...
                        Button koltukButton = (Button) kirkKoltukPane.lookup("#" + buttonId);
        ...
        Timeline timeline = new Timeline(new KeyFrame(
                ...
                new EventHandler<ActionEvent>() {
                    ...
                    public void handle(ActionEvent event) {
                        Stage stage = (Stage) kirkKoltukPane.getScene().getWindow();
                        stage.close();
                    }
                }));
        timeline.play();
